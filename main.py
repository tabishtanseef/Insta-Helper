...
def get_like_list(insta_username):
    ...
    if like_info['meta']['code'] == 200:
        if len(like_info['data']) > 0:
            ...
            print 'There are no existing likes on this post!'
    else:
        print 'Status code other than 200 received!'
    ...
    if comment_info['meta']['code'] == 200:
        if len(comment_info['data']) > 0:
            ...
            for user_info in comment_info['data']:
                if comment_info['data'][position - 1]['text']:
                    print comment_info['data'][position - 1]['from']['username'] + ' said: ' + comment_info['data'][position - 1]['text']
                    position = position + 1
                else:
